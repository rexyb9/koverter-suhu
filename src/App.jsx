import { FluentProvider, Caption1, Card, CardHeader, Body1, webLightTheme, CardFooter, Button, Select, Input } from "@fluentui/react-components";
  ...
  return (
    <FluentProvider theme={webLightTheme}>
      <Card style={{ width: 400 }}>
        ...
        <Input placeholder="input suhu" type="number" onChange={(e) => setTemperatureInput(e.target.value)} />
        <CardFooter>
          <Button icon={<ConvertRangeRegular fontSize={16} />} className="btn__convert" onClick={handleTemperature}>
            Convert
          </Button>
